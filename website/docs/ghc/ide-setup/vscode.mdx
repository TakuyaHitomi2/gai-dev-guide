...
1. GitHub CopilotとGitHub Copilot Chatの拡張機能をインストールします。
    1. [Visual Studio CodeのMarketMarketplace](https://marketplace.visualstudio.com/)で[GitHub Copilot](https://marketplace.visualstudio.com/items?itemName=GitHub.copilot)を開き Installボタンを押下してください。
    1. Visual Studio Code が開き、拡張機能の画面が開きます。
    1. Visual Studio Code 上で Install ボタンを押下してください。
        ![GitHub Copilotのインストール](./imgs/install-ghc.gif)
    1. GitHub Copilot Chat も同様にインストールしてください
